...
sections:
  - type: GenericSection
    title:
      text: kamar 9 binayah (DEC)
      color: text-dark
      type: TitleBlock
    subtitle: be humble but noble
    text: >
  ...
  - title: Divider
    ...
    type: DividerSection
  - title:
      text: PENERIMAAN ANGGOTA BARU DEC
      color: text-dark
      styles:
        self:
          textAlign: center
